...
1. Compile both notebooks as Python.
2. Run strict marimo checks and execute or export both notebooks in a clean
   environment.
...
4. For Module 02, check mass-action residuals, scaled electroneutrality
   ...
   them.
5. Run git diff --check and review all rendered figures at projector scale.
